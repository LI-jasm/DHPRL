    ...
    for line in f:
        ...
        if len(line)==2:
            if line[0] !=line[1]:
                ...
                neighbor_PPI_list[Dic_map[line[0]]].add(line[1])
                neighbor_PPI_list[Dic_map[line[1]]].add(line[0])
                
                
                if len(protein_time_list[Dic_map[line[0]]]&protein_time_list[Dic_map[line[1]]])>0:
                        # or len(protein_time_list[Dic_map[line[0]]])==0 or len(protein_time_list[Dic_map[line[1]]])==0:  # 如果PPI对应的两节点活性时间有重复时段
                    ...
                    neighbor_list[Dic_map[line[0]]].add(line[1])  # 记录新PPIN中每个节点的邻居节点
